...
public final class PaymentServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.research.grpc.PaymentService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.research.grpc.PaymentMessage,
      com.research.grpc.PaymentMessage> getCheckPaymentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "checkPayment",
      requestType = com.research.grpc.PaymentMessage.class,
      responseType = com.research.grpc.PaymentMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.research.grpc.PaymentMessage,
      com.research.grpc.PaymentMessage> getCheckPaymentMethod() {
    io.grpc.MethodDescriptor<com.research.grpc.PaymentMessage, com.research.grpc.PaymentMessage> getCheckPaymentMethod;
    if ((getCheckPaymentMethod = PaymentServiceGrpc.getCheckPaymentMethod) == null) {
      synchronized (PaymentServiceGrpc.class) {
        if ((getCheckPaymentMethod = PaymentServiceGrpc.getCheckPaymentMethod) == null) {
          PaymentServiceGrpc.getCheckPaymentMethod = getCheckPaymentMethod =
              io.grpc.MethodDescriptor.<com.research.grpc.PaymentMessage, com.research.grpc.PaymentMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "checkPayment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.research.grpc.PaymentMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.research.grpc.PaymentMessage.getDefaultInstance()))
              .setSchemaDescriptor(new PaymentServiceMethodDescriptorSupplier("checkPayment"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void checkPayment(com.research.grpc.PaymentMessage request,
        io.grpc.stub.StreamObserver<com.research.grpc.PaymentMessage> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCheckPaymentMethod(), responseObserver);
    }
  }
  ...
  public static final class PaymentServiceStub
    ...
    /**
     */
    public void checkPayment(com.research.grpc.PaymentMessage request,
        io.grpc.stub.StreamObserver<com.research.grpc.PaymentMessage> responseObserver) {
  ...
  public static final class PaymentServiceBlockingStub
    ...
    /**
     */
    public com.research.grpc.PaymentMessage checkPayment(com.research.grpc.PaymentMessage request) {
  ...
  public static final class PaymentServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.research.grpc.PaymentMessage> checkPayment(
        com.research.grpc.PaymentMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_PAYMENT:
          serviceImpl.checkPayment((com.research.grpc.PaymentMessage) request,
              (io.grpc.stub.StreamObserver<com.research.grpc.PaymentMessage>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.research.grpc.PaymentMessage,
              com.research.grpc.PaymentMessage>(
                service, METHODID_CHECK_PAYMENT)))
        .build();
  }
  ...
  private static abstract class PaymentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.research.grpc.PaymentServiceOuterClass.getDescriptor();
    }
