package com.research.te02PaymentService.kafka;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.research.te02PaymentService.constants.RequestCodes;
import com.research.te02PaymentService.constants.ResponseCodes;
import com.research.te02PaymentService.model.OrderRequest;
...
public class PaymentConsumer {
	...
	@KafkaListener(topics = "te02paymenttopic", groupId = "kafkagroup")
